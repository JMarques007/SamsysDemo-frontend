      ...
      <div className="row">
        ...
        <div className="col-2">
          <button
            ...
            onClick={() => getClientsByPage(currentPage, searchTerm)}
          >
            Find
          </button>
          <Link to="/client/new" className="btn btn-secondary">
            New
          </Link>
        </div>
            ...
            <tbody>
              {clients?.map((client, index) => (
                ...
                >
                  ...
                  <td className="text-right col-contact">
                    {client.phoneNumber}
                  </td>
                  <td>
                  ...
                  <td>
                    <Link to={`/client/edit/${client.id}`}>📝</Link>
                  </td>
                </tr>
              ))}
            </tbody>
